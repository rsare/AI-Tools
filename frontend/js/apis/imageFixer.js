  ...
  app.innerHTML = `
    <style>
      ...
      .ifix-card{
        ...
        background:linear-gradient(180deg,rgba(15, 4, 63, 0.06),rgba(255,255,255,.03));
        border:1px solid rgba(15, 2, 71, 0.1);
      ...
      .ifix-drop{border:2px dashed rgba(3, 1, 78, 0.18); border-radius:16px; padding:12px; transition:.2s;}
    ...
    <div class="ifix-shell">
      <section class="panel" aria-labelledby="ifix-title">
      <h2 id="ifix-title" class="h2 title">Image Fixer</h2>
      <p class="muted">PNG/JPEG ve <strong>maksimum 500 KB</strong> yükleyin.</p>

    <div class="drop" id="ifixDrop">
      <label class="ifix-row" for="imageInput">
        <span class="file-pill">Dosya Seç</span>
        <span class="ifix-name" id="ifixName">Dosya seçilmedi</span>
        <input type="file" id="imageInput" accept="image/png,image/jpeg">
      </label>
    </div>

    <p class="muted" style="text-align:center;margin:12px 0 16px">
      İpucu: Çok büyük dosyaları yüklemekte zorlanırsanız görseli sıkıştırmayı deneyin.
    </p>

    <button id="go" class="btn">Görseli Gönder</button>
    <div id="out" class="output">Çıktı burada görünecek.</div>
