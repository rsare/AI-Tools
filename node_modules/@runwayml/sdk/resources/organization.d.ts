...
export interface OrganizationRetrieveUsageResponse {
     ...
     */
    models: Array<'upscale_v1' | 'act_two' | 'gen4_image' | 'gen3a_turbo' | 'gen4_turbo' | 'gen4_aleph' | 'gen4_image_turbo'>;
...
export declare namespace OrganizationRetrieveUsageResponse {
    ...
    namespace Result {
        interface UsedCredit {
             ...
             */
            model: 'upscale_v1' | 'act_two' | 'gen4_image' | 'gen3a_turbo' | 'gen4_turbo' | 'gen4_aleph' | 'gen4_image_turbo';
        }
    }
}
